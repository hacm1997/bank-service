...
urlpatterns = [
    ...
    path('account/kpi/<str:link_id>/<str:account_id>', AccountController.as_view(), name="account-id-detail"),
    path('transactions/<str:link_id>/<str:account_id>', TransactionController.as_view(), name="transactions-detail"),
    path('transaction/details/<str:transaction_id>', TransactionController.as_view(), name="transaction-detail"),
